                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final checkOut =
                          latestThreeData[index]['check_out'] ?? 'N/A';
                      final formattedCheckIn = checkIn != 'N/A'
                          ? TimeOfDay.fromDateTime(DateTime.parse(checkIn))
                              .format(context)
                          : 'N/A';
                      final formattedCheckOut = checkOut != 'N/A'
                          ? TimeOfDay.fromDateTime(DateTime.parse(checkOut))
                              .format(context)
                          : 'N/A';
